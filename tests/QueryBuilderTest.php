...
class QueryBuilderTest extends \yiiunit\framework\db\QueryBuilderTest
{
    ...
    {
        return [
            [Schema::TYPE_PK, $this->primaryKey(), 'integer NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1)'],
            [Schema::TYPE_PK . ' CHECK (value > 5)', $this->primaryKey()->check('value > 5'), 'integer NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) CHECK (value > 5)'],
